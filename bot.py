...
async def idea(ctx):
    ...
    await ctx.send("Worry not, you're gonna be fine")

    topics = ["chat bot", "cli", "game", "web bot", "browser extension", "api", "website"]
...
@bot.command(name="calc", help="Do a two number operation where function is either +, -, *, or /.")
